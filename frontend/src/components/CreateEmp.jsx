...
function CreateEmp() {
    ...
    const onFormSubmit = async (newEmpObj) => {
        ...
        try {
            setError(null)
            setLoading(true)
            let res = await fetch("https://employee-management-62yk.onrender.com/employee-api/employee", {
                method: "POST",
    ...
    return (
        <div>
            <form className="bg-white-50 w-155 mx-auto h-100 py-5 rounded-4xl border-2 border-blue-950 shadow-2xl" onSubmit={handleSubmit(onFormSubmit)}>
